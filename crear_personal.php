                ...
                <form ="registro" method="post" action="registro.php" enctype="application/x-www-form-urlencoded">
                  ...
                  <?php
				   ...
				   error_reporting(E_ALL  ^  E_NOTICE  ^  E_WARNING); 
                        ...
                        if ($_GET["per"]=="si") { 
                        echo "<span> <br>Usuario creado correctamente</span>";
					  }else if($_GET["per"]=="no"){
						  echo "<span> <br> Usuario Ya existe! Intente con otro rut</span>";
					  }else if($_GET["per"]=="igual"){
						  echo "<span> <br>Las contraseñas no coinciden</span>";
					  }
