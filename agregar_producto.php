    ...
    <body>
        ...
        <br><h1 align="center">GESTIÓN DE PRODUCTOS</h1>     
            ...
            <div class="formulario">
                ...
                <form name="registro" method="post" action="operacion.guardar.php" enctype="application/x-www-form-urlencoded">
                    <div class="campo">
				   ...
				   error_reporting(E_ALL  ^  E_NOTICE  ^  E_WARNING); 
                        ...
                        if ($_GET["agregar"]=="si") { 
                        echo "<span>Producto Guardado Satisfactoriamente</span>";
					  }else if($_GET["agregar"]=="no"){
						  echo "<span>Ya existe un producto asociado al codigo ingresado, intentelo nuevamente</span>";
					  }
