	...
	<body>
		...
		<div class="contenedor">
	        ...
	        <div class="formulario">
				...
				$consulta = "SELECT * FROM personal WHERE rut = '$seleccionar'";
				$ejecutar = mysql_query($consulta, $conexion);
				$resul = mysql_num_rows($ejecutar);
		
				//$resul;			
				if ($resul > 0 ) {	
				$sql="UPDATE personal SET nombre='$nombre', apellido='$apellido', cargo='$cargo' WHERE rut ='$seleccionar'";
				$mysql = mysql_query($sql, $conexion);
				echo "<script lenguaje='javascript'>alert('Personal actualizado');</script>";
